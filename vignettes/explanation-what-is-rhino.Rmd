...
__Disclaimer:__ _Rhino is an opinionated framework with a focus on best practices and development tools._
...
It has since evolved into an R package that we are now excited to share with the Shiny community. 
...
<!-- Rhino does not attempt to replace Golem - we believe both have perfect use cases.  -->

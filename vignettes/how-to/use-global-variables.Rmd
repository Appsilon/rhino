...
Storing constants is the most common reason for a global definition.
...
If the variable can change its value at any point in the app, future changes to the app must consider how this global variable will be affected. A changing global variable may also make testing difficult because tests may affect the global variables. The tests are no longer independent of each other. The global variable's value depends on the steps it takes; concurrency issues may occur.
...
```r
# app/logic/answer.R
box::use(app/logic/global[global])
...
box::use(
  app/logic/global[global, update_answer],
  app/logic/answer
)

global$answer # This is still 42

update_answer()

global$answer # This returns 25
```

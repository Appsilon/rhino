...
To use [`shinymanager`](https://datastorm-open.github.io/shinymanager/) in Rhino
you will need to setup a [legacy entrypoint](https://appsilon.github.io/rhino/reference/app.html#legacy-entrypoint)
in your `rhino.yml`:

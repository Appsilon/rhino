...
In the first example we are going to pass information (reactive variables) from a parent module to a child module and
...
`utils.R ` module are mocked functions that we are using for the purpose of aiding the example. These funcions are not

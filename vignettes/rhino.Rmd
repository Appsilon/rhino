...
Rhino forces you to use [`renv` package](https://rstudio.github.io/renv/index.html) for dependency management.
...
For parts of code that are not Shiny modules, we recommend storing them in `app/logic` directory.

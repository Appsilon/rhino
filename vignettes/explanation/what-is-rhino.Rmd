...
**Disclaimer:** *Rhino is an opinionated framework with a focus on best practices and development tools.*
...
Rhino is not the first project of its kind aimed at helping the Shiny community to enhance the structure of their applications. We believe that each of these has value, and it is up to the developer to decide what is best for them in their project. <!-- Rhino does not attempt to replace Golem - we believe both have perfect use cases.  -->

...
Instead of `server.R` and `ui.R`, Rhino uses a single file `main.R`.
...
need to use namespacing (`ns`) in the UI part.

</details>

<details>
<summary>Where is `global.R` file?</summary>
...
<details>
<summary>Where is `www` directory?</summary>
...
<details>
<summary>Why my `input` does not trigger the reactive chain?</summary>
...
<details>
<summary>Why my `output` is not visible?</summary>

...
To get started, the first thing you will need to install Rhino itself, which can be done with the standard R command:
...
using the `pivot_wider` function from the `tidyr` package. First, let's install it:
...
First, as expected, you need to install the `dplyr` package:

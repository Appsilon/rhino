...
you'll need to [install Node.js](https://nodejs.org/en/download/) (v20 or later) on your system.
...
We will be using a total of 5 packages for this application.
...
and update `dependencies.R` and `renv.lock` files accordingly.

**Note:** *Package `htmlwidgets` is already installed since it is a dependency for `shiny`,

...
This tutorial uses native pipe operator `|>` introduced in R 4.1 release. If you use an earlier R version, then you can use `%>%` operator found in magrittr and dplyr packages instead.*

# How-to: Rhino 1.9 Migration Guide

Follow the steps outlined in this guide to migrate your project to Rhino
1.9. Before starting, ensure your Git working tree is clean, or back up
your project if not using Git.

This guide assumes you are migrating from Rhino 1.8. If you are
...
Use the following command to install Rhino 1.9 and update your
`renv.lock` file:
...
Remove the `.rhino` directory from the root of your project. This
directory contains Node.js configuration from the previous version of
Rhino.

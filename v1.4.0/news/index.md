...
3.  Require box v1.3.1 or later (fixes issues with lazy-loaded data and
    trailing commas).
...
1.  [`test_r()`](https://appsilon.github.io/rhino/v1.4.0/reference/test_r.md)
...
2.  Sass-specific at-rules are now recognized by
    [`rhino::lint_sass()`](https://appsilon.github.io/rhino/v1.4.0/reference/lint_sass.md)

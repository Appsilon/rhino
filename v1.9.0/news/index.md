...
1.  Added `sass: custom` configuration option for cleaner integration
    with `bslib`.
2.  Introduced
    [`format_js()`](https://appsilon.github.io/rhino/v1.9.0/reference/format_js.md)
    and
    [`format_sass()`](https://appsilon.github.io/rhino/v1.9.0/reference/format_sass.md)
    powered by [prettier](https://prettier.io).
    - **Note:**
      [`lint_js()`](https://appsilon.github.io/rhino/v1.9.0/reference/lint_js.md)
      and
      [`lint_sass()`](https://appsilon.github.io/rhino/v1.9.0/reference/lint_sass.md)
...
2.  Major refactor of
    [`rhino::app()`](https://appsilon.github.io/rhino/v1.9.0/reference/app.md):
...
3.  Upgrade tools based on Node.js:
    - [`test_e2e()`](https://appsilon.github.io/rhino/v1.9.0/reference/test_e2e.md)
      now uses `cypress` 13.6
    - [`build_js()`](https://appsilon.github.io/rhino/v1.9.0/reference/build_js.md)
...
1.  New
    [`pkg_install()`](https://appsilon.github.io/rhino/v1.9.0/reference/dependencies.md)
    and
    [`pkg_remove()`](https://appsilon.github.io/rhino/v1.9.0/reference/dependencies.md)
...
2.  Add support for using React in Rhino (tutorial, JS function
    ...
    [`react_component()`](https://appsilon.github.io/rhino/v1.9.0/reference/react_component.md)).
...
1.  [`test_r()`](https://appsilon.github.io/rhino/v1.9.0/reference/test_r.md)
...
4.  The
    [`lint_r()`](https://appsilon.github.io/rhino/v1.9.0/reference/lint_r.md)
    now accepts a `paths` argument which can be used to run it on
    specific files.
5.  The
    [`init()`](https://appsilon.github.io/rhino/v1.9.0/reference/init.md)
...
2.  Sass-specific at-rules are now recognized by
    [`rhino::lint_sass()`](https://appsilon.github.io/rhino/v1.9.0/reference/lint_sass.md)

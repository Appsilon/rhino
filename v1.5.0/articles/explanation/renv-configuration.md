...
[`rhino::pkg_install()`](https://appsilon.github.io/rhino/v1.5.0/reference/dependencies.md)
and
[`rhino::pkg_remove()`](https://appsilon.github.io/rhino/v1.5.0/reference/dependencies.md).

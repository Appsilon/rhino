...
Call `options(shiny.autoreload = TRUE)` in your R session. Shiny will
monitor the app directory and reload all connected sessions if any
changes are detected. More details can be found in [Shiny
reference](https://shiny.posit.co/r/reference/shiny/latest/shinyoptions).

Note: you have to use
[`shiny::runApp()`](https://rdrr.io/pkg/shiny/man/runApp.html) for the
autoreload to work - using
[`rhino::app()`](https://appsilon.github.io/rhino/v1.10.1/reference/app.md)
*won’t* work. For context see [issue \#3964 in
Shiny](https://github.com/rstudio/shiny/issues/3964).

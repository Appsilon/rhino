...
As of Rhino version 1.10.0,
[`format_r()`](https://appsilon.github.io/rhino/v1.10.1/reference/format_r.md)
includes styling for
[`box::use()`](https://klmr.me/box/reference/use.html) calls. This is
provided by [`{box.linters}`](https://appsilon.github.io/box.linters/)
version \>= 0.10.4. As with [`{styler}`](https://styler.r-lib.org/),
carefully examine the styling results after performing automated styling
on your code.
...
1.  [`box::use()`](https://klmr.me/box/reference/use.html) call styling
    is included when running
    [`format_r()`](https://appsilon.github.io/rhino/v1.10.1/reference/format_r.md).
2.  It can also be separately executed by running one of the
    [`box.linters::style_*`](https://appsilon.github.io/box.linters/reference/index.html#box-styling)
    functions.

For more information on the abilities of `{{box.linters}}` styling
functions refer to the styling functions

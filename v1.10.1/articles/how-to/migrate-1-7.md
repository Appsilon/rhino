# How-to: Rhino 1.7 Migration Guide

Follow the steps outlined in this guide to migrate your project to Rhino
1.7. Before starting, ensure your Git working tree is clean, or back up
your project if not using Git.

This guide assumes you are migrating from Rhino 1.6. If you are
...
Use the following command to install Rhino 1.7 and update your
`renv.lock` file:
...
Edit the `.lintr` file in your project so it includes the following
rules:

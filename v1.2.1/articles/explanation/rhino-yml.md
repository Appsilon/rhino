...
Configures whether [Sass](https://sass-lang.com/) should be built using
the [R package](https://cran.r-project.org/package=sass) or the [Node.js
package](https://www.npmjs.com/package/sass). Read more in [Explanation:
Node.js - JavaScript and Sass

...
To get started, the first thing you will need to install Rhino itself:
...
Your application runs, but it seems to be quite empty. Let’s add
something there!
...
In this stage, the application has working components, but it does not
look well.
...
[`rhino::build_sass()`](https://appsilon.github.io/rhino/v1.0.0/reference/build_sass.md)!
...
[`rhino::build_js`](https://appsilon.github.io/rhino/v1.0.0/reference/build_js.md)
function. Try it:

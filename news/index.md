...
3.  Bugfix for
    [`format_r()`](https://appsilon.github.io/rhino/reference/format_r.md)
    and single files.
...
2.  Major refactor of
    [`rhino::app()`](https://appsilon.github.io/rhino/reference/app.md):
...
3.  Upgrade tools based on Node.js:
    - [`test_e2e()`](https://appsilon.github.io/rhino/reference/test_e2e.md)
...
1.  New
    [`pkg_install()`](https://appsilon.github.io/rhino/reference/dependencies.md)
    and
    [`pkg_remove()`](https://appsilon.github.io/rhino/reference/dependencies.md)
...
2.  Add support for using React in Rhino (tutorial, JS function
    ...
    [`react_component()`](https://appsilon.github.io/rhino/reference/react_component.md)).
...
1.  [`test_r()`](https://appsilon.github.io/rhino/reference/test_r.md)
...
4.  The
    [`lint_r()`](https://appsilon.github.io/rhino/reference/lint_r.md)
    now accepts a `paths` argument which can be used to run it on
    specific files.
5.  The [`init()`](https://appsilon.github.io/rhino/reference/init.md)
...
2.  Sass-specific at-rules are now recognized by
    [`rhino::lint_sass()`](https://appsilon.github.io/rhino/reference/lint_sass.md)

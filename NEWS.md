...
5. Added `use_e2e_tests()` for scaffolding the Cypress end-to-end test structure into an existing Rhino project. The backup-on-conflict mechanism now handles directories as well as single files.

...
[`rhino::pkg_install()`](reference/dependencies.md) and
[`rhino::pkg_remove()`](reference/dependencies.md).
...
[`rhino::pkg_install()`](reference/dependencies.md) and
[`rhino::pkg_remove()`](reference/dependencies.md). However it is still
possible to manage dependencies using the underlying

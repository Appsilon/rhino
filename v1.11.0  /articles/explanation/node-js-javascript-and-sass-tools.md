...
1.  [`build_js()`](reference/build_js.md)
2.  [`build_sass()`](reference/build_sass.md) (with `sass: node`
    configuration in `rhino.yml`)
3.  [`lint_js()`](reference/lint_js.md)
4.  [`lint_sass()`](reference/lint_sass.md)
5.  [`test_e2e()`](reference/test_e2e.md)
...
The [`build_sass()`](reference/build_sass.md) function is worth an
additional comment. Depending on the configuration in `rhino.yml` it can
use either the [sass](https://www.npmjs.com/package/sass) Node.js
package or the [sass](https://rstudio.github.io/sass/) R package. We
recommend the Node.js version, as it is the primary, actively developed

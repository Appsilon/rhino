...
your application. Steps performed by [`rhino::app()`](reference/app.md)
include:
...
pass it to [`rhino::app()`](reference/app.md) as arguments as we would
with a normal `shiny::shinyApp() call`?

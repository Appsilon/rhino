...
autoreload to work - using [`rhino::app()`](reference/app.md) *won’t*
work. For context see [issue \#3964 in
...
parameters](articles/how-to/set-application-run-parameters.md).
...
[`rhino::build_sass()`](reference/build_sass.md) will be sufficient to

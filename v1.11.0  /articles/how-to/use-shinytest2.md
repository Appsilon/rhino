...
[`rhino::test_e2e()`](reference/test_e2e.md) without any additional
setup. If you’d prefer to use the `shinytest2` package instead, you will
need to:
...
tests and can be run with [`rhino::test_r()`](reference/test_r.md).

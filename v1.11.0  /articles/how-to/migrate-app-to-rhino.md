...
The process described in [`rhino::init()`](reference/init.md)
...
In general you use [`rhino::init()`](reference/init.md) for migration.
...
[`rhino::init()`](reference/init.md) from a different directory (or
perhaps run renv::deactivate()).

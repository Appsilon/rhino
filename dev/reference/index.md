...
- [`pkg_install()`](https://appsilon.github.io/rhino/dev/reference/dependencies.md)
  ...
  : Manage dependencies
- [`log`](https://appsilon.github.io/rhino/dev/reference/log.md) :
  Logging functions
...
- [`` `%<-%` ``](https://appsilon.github.io/rhino/dev/reference/grapes-set-grapes.md)
  **\[experimental\]** : Destructure a named list into individual
  variables

## Data

- [`rhinos`](https://appsilon.github.io/rhino/dev/reference/rhinos.md) :

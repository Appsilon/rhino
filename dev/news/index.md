...
3.  Added
    ...
    for scaffolding an `AGENTS.md` file with guidance for AI coding
    agents in a Rhino app.
4.  Added
...
5.  Added
    ...
    [`init()`](https://appsilon.github.io/rhino/dev/reference/init.md)
    for scaffolding the Cypress end-to-end test structure. The
...
2.  Major refactor of
    [`rhino::app()`](https://appsilon.github.io/rhino/dev/reference/app.md):
...
1.  [`test_r()`](https://appsilon.github.io/rhino/dev/reference/test_r.md)
...
2.  Sass-specific at-rules are now recognized by
    [`rhino::lint_sass()`](https://appsilon.github.io/rhino/dev/reference/lint_sass.md)

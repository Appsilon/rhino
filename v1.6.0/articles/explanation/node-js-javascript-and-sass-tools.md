...
1.  [`build_js()`](https://appsilon.github.io/rhino/v1.6.0/reference/build_js.md)
2.  [`build_sass()`](https://appsilon.github.io/rhino/v1.6.0/reference/build_sass.md)
    (with `sass: node` configuration in `rhino.yml`)
3.  [`lint_js()`](https://appsilon.github.io/rhino/v1.6.0/reference/lint_js.md)
4.  [`lint_sass()`](https://appsilon.github.io/rhino/v1.6.0/reference/lint_sass.md)
5.  [`test_e2e()`](https://appsilon.github.io/rhino/v1.6.0/reference/test_e2e.md)
